...
public class MyThemesAdapter extends ArrayAdapter {
    ...
    public View getView(int position, View convertview, ViewGroup parent)
    {
        ...
        if(convertview==null){
            ...
            view=convertview;
        TextView mainActivity_themes_title_tv=(TextView)view.findViewById(R.id.mainActivty_singletheme_title);
    ...
    public  void addThemes(Theme theme)
    {
        ...
        theme.save(new SaveListener<String>() {
            ...
            public void done(String s, BmobException e) {
                if(e==null)
                {
                    Toast.makeText(MainActivity.getContext(),"save theme ok",Toast.LENGTH_LONG).show();
                }
            }
        });
